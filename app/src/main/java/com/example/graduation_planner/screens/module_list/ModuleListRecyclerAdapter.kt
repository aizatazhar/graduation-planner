...
class ModuleListRecyclerAdapter(var deleteModuleCallback: (module: Module) -> Unit, var modules: List<Module>) : RecyclerView.Adapter<ModuleListRecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModuleListRecyclerAdapter.ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.module_layout, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ModuleListRecyclerAdapter.ViewHolder, position: Int) {
